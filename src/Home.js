				...
				<tr>
					<td style={{ alignItems: "left" }}>
						<a href="https://en.wikipedia.org/wiki/Donald_Trump">
							<img
								...
								src={portrait}
								alt=""
								style={{ width: "300px", height: "400px" }}></img>
						</a>
					</td>
					...
					<td style={{ alignItems: "left", verticalAlign: "top" }}>
						...
						<p style={{ fontSize: "120%" }}>
							...
							nominee{" "}
							<a style={{ color: "black" }} href="https://en.wikipedia.org/wiki/Hillary_Clinton">
								Hillary Clinton
							</a>{" "}
							while losing the popular vote. He became the oldest first-term U.S. president and the
