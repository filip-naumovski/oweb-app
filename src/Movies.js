...
function Movies() {
    ...
    return (
        <motion.div initial={{ scale: 1, opacity: 0, y: 2000 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: '1.2' }} className="musicDiv">
            <h1 style={{ textAlign: "center", fontFamily: "Verdana", marginTop: "2vh", fontSize: 40 }} className="comment">Favorite movies:</h1>
            <motion.div className="verticalMenu" initial={{ y: 1000 }} animate={{ y: 0 }} transition={{ duration: '1' }}>
                <button className="musicButton" onClick={(e) => handleClick(e)} name="inc">Inception</button>
                {movies["inc"]
                    ?
                    <motion.table initial={{ y: 1000 }} animate={{ y: 0 }} transition={{ duration: '1' }}>
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="https://www.imdb.com/title/tt1375666/"><img src={Inception} className="musicImages" alt="" /></a>
                                </div>
                            </td>
                    ...
                    : null}
                <button className="musicButton" onClick={(e) => handleClick(e)} name="rev">Star Wars Episode III: Revenge of the Sith</button>
                {movies["rev"]
                    ?
                    <motion.table initial={{ y: 1000 }} animate={{ y: 0 }} transition={{ duration: '1' }}>
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="https://www.imdb.com/title/tt0121766/"><img src={Revenge} className="musicImages" alt="" /></a>
                                </div>
                            </td>
                            <td className="paragraphTd">
                                <div className="paragraph">
                    ...
                    : null}
                <button className="musicButton" onClick={(e) => handleClick(e)} name="good">Goodfellas</button>
                {movies["good"]
                    ?
                    <motion.table initial={{ y: 1000 }} animate={{ y: 0 }} transition={{ duration: '1' }}>
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="https://www.imdb.com/title/tt0099685/"><img className="musicImages" src={Goodfellas} alt="" /></a>
                                </div>
                            </td>
                            <td className="paragraphTd">
                                <div className="paragraph">
