...
function Survey() {
  ...
  return (
    <div>
      <h1 className={submitted ? "surveyPopup" : "surveyPopupHidden"}>
        Thanks for submitting!
      </h1>
      <motion.div
        initial={{ scale: 1, opacity: 1, y: 1000 }}
      ...
      >
        <table className="submitted-table" align="center">
          {!submitted ? (
            <tr>
              <td>
                ...
                >
                  ...
                  <textarea
                    className="surveyComment"
                    placeholder="Any additional comments?"
                    value={state.comment}
                    onChange={handleChange()}
                    name="comment"
                  />
                  <button type="submit" className="button-comment-survey">
                    Submit
                  </button>
                </form>
              </td>
            ...
            <div>
              <motion.div
                initial={{ scale: 1, opacity: 1, y: -1000, zIndex: -999 }}
