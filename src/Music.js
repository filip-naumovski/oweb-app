...
function Music() {
    ...
    return (
        <motion.div initial={{ scale: 1, opacity: 0, y: 2000 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: '1.2' }} className="musicDiv">
            <h1 style={{ textAlign: "center", fontFamily: "Verdana", marginTop: "2vh", fontSize: 40 }} className="comment">Favorite artists:</h1>
            <motion.div className="verticalMenu" initial={{ y: 1000 }} animate={{ y: 0 }} transition={{ duration: '1' }}>
                <button className="musicButton" onClick={(e) => handleClick(e)} name="ye">Kanye West</button>
                {artists["ye"]
                    ?
                    <motion.table initial={{ y: 1000 }} animate={{ y: 0 }} transition={{ duration: '1' }}>
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="https://en.wikipedia.org/wiki/Kanye_West"><img src={kanye} className="musicImages" alt="" /></a>
                                </div>
                            </td>
                            <td className="paragraphTd">
                                <div className="paragraph">Kanye Omari West (/ˈkɑːnjeɪ/; born June 8, 1977) is an American rapper, record producer, and fashion designer. Throughout his career, West has been responsible for cultural movements and musical progressions within mainstream hip-hop and popular music at large. Born in Atlanta and raised in Chicago, he was first known as a producer for Roc-A-Fella Records in the early 2000s, producing singles for several mainstream artists. Intent on pursuing a solo career as a rapper, West released his debut album The College Dropout in 2004 to critical and commercial success, and founded the record label GOOD Music. In 2020, West said he would be running for president under the Birthday Party.</div>
                            </td>
                        </tr>
                    </motion.table>
                    : null}
                <button className="musicButton" onClick={(e) => handleClick(e)} name="met">Metallica</button>
                {artists["met"]
                    ?
                    <motion.table initial={{ y: 1000 }} animate={{ y: 0 }} transition={{ duration: '1' }}>
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="https://en.wikipedia.org/wiki/Metallica"><img src={metallica} className="musicImages" alt="" /></a>
                                </div>
                            </td>
                            <td className="paragraphTd">
                                <div className="paragraph">Metallica is an American heavy metal band. The band was formed in 1981 in Los Angeles by vocalist/guitarist James Hetfield and drummer Lars Ulrich, and has been based in San Francisco for most of its career. The band's fast tempos, instrumentals and aggressive musicianship made them one of the founding "big four" bands of thrash metal, alongside Megadeth, Anthrax and Slayer. Metallica's current lineup comprises founding members and primary songwriters Hetfield and Ulrich, longtime lead guitarist Kirk Hammett, and bassist Robert Trujillo. Guitarist Dave Mustaine (who went on to form Megadeth after being fired from the band) and bassists Ron McGovney, Cliff Burton (who died in a bus accident in Sweden in 1986) and Jason Newsted are former members of the band.</div>
                            </td>
                        </tr>
                    </motion.table>
                    : null}
                <button className="musicButton" onClick={(e) => handleClick(e)} name="ken">Kendrick Lamar</button>
                {artists["ken"]
                    ?
                    <motion.table initial={{ y: 1000 }} animate={{ y: 0 }} transition={{ duration: '1' }}>
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="https://en.wikipedia.org/wiki/Kendrick_Lamar"><img src={kendrick} className="musicImages" alt="" /></a>
                                </div>
                            </td>
                            <td className="paragraphTd">
