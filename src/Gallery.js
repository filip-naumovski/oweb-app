        ...
        <div>
            ...
            <motion.div initial={{ scale: 1, opacity: 0 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: '0.7' }}>
                <table className="table">
                    <tbody>
                        <img src={seed} alt="" className="images-inv" onLoad={e => imageLoaded(e)} name="loaded2" />
                        <tr>
                            <td style={{ textAlign: "left" }} className="gallery-element">
                                <div>
                                    <div>
                                        {state.loaded1 ? <img src={imageStrings.image1} alt="" className="images" onDoubleClick={e => handleClickImg(e)} name="image1" /> : <img alt="" src={loading} className="loading" />}
                                        <div>
                                    ...
                                    <table style={{ tableLayout: "fixed" }}>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div style={{ textAlign: "right", marginLeft: '5px' }}>
                            ...
                            <td style={{ textAlign: "left" }} className="gallery-element">
                                <div>
                                    <div>
                                        {state.loaded2 ? <img src={seed} alt="" className="images" onDoubleClick={e => handleClickImg(e)} name="image2" /> : <img alt="" src={loading} className="loading" />}
                                        <div>
